...
SELECT * FROM CRITICAL_SERCHIO WHERE YEAR(DateOnly) = YEAR(CURDATE()) UNION
SELECT * FROM CRITICAL_WINWATCH WHERE YEAR(DateOnly) = YEAR(CURDATE()) ORDER BY DateOnly DESC;